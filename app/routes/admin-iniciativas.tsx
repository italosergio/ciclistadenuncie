          ...
          <div className="relative bg-slate-900 border border-white/10 rounded-2xl shadow-2xl w-full max-w-lg max-h-[85vh] flex flex-col overflow-hidden" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <p className="text-[11px] uppercase tracking-wide text-slate-400 font-semibold mb-1">Latitude</p>
                  <p className="text-sm text-white">{modalIniciativa.lat ?? 'N/A'}</p>
                </div>
                <div>
                  <p className="text-[11px] uppercase tracking-wide text-slate-400 font-semibold mb-1">Longitude</p>
                  <p className="text-sm text-white">{modalIniciativa.lng ?? 'N/A'}</p>
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm text-white">{modalIniciativa.createdAt ? new Date(modalIniciativa.createdAt).toLocaleDateString('pt-BR') : 'N/A'}</p>
              </div>
            </div>
          </div>
        </div>
